...
function Hero() {
  return (
    <section className="relative overflow-hidden px-4 pb-14 pt-6 sm:pb-20 sm:pt-10 lg:px-8 lg:pt-16">
      ...
      <div className="container mx-auto flex flex-col items-center gap-6 sm:gap-12 lg:grid lg:grid-cols-[1.05fr_1fr] lg:items-center lg:gap-10">
        <motion.div
...
function Plans() {
  ...
  return (
    <section id="planos" className="container mx-auto scroll-mt-20 px-4 py-14 lg:px-8 lg:py-24">
      ...
      <div className="mt-10 grid items-center gap-5 sm:mt-14 lg:mt-20 lg:grid-cols-3">
        {plans.map((p, i) => (
          <motion.div
            key={p.name}
