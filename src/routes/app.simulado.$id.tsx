          ...
          <div className="rounded-2xl border border-border bg-gradient-hero p-4 text-white shadow-elegant">
            ...
            {isWaiting && (
              <button
                type="button"
                onClick={startTimer}
                style={{ color: "hsl(var(--medical, 210 80% 28%))" }}
                className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-primary shadow-sm transition hover:bg-white/90 hover:shadow active:scale-[0.98]"
              >
