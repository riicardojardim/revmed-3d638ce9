        ...
        >
          ...
          <div className="grid gap-5 p-4 sm:gap-6 sm:p-10 lg:grid-cols-[1.4fr_1fr]">
            <div className="flex flex-col justify-between gap-5 sm:gap-6">
              ...
              <div>
                <h1 className="font-display text-[1.35rem] font-bold leading-[1.1] tracking-tight lg:text-5xl lg:leading-[1.05] xl:text-6xl">
                ...
                <p className="mt-3 max-w-md text-[0.8rem] leading-relaxed text-muted-foreground lg:mt-4 lg:text-base">
                  Sua bancada particular de treino para o Revalida — sem firula, com método.
                </p>
              </div>
              <div className="flex flex-nowrap items-stretch gap-2 lg:flex-wrap lg:gap-3">
                <Link
                  to="/app/checklists"
                  className="group inline-flex flex-1 items-center justify-center gap-1.5 rounded-full bg-medical px-3 py-2 text-[0.72rem] font-semibold text-night transition-all hover:shadow-glow lg:flex-none lg:px-5 lg:py-2.5 lg:text-sm"
                >
                  Começar treino
                  <ArrowUpRight className="h-3.5 w-3.5 shrink-0 transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5 lg:h-4 lg:w-4" />
                </Link>
                <Link
                  to="/app/progresso"
                  className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-full border border-border px-3 py-2 text-[0.72rem] font-medium text-muted-foreground transition-colors hover:border-medical hover:text-foreground lg:flex-none lg:px-4 lg:py-2.5 lg:text-sm"
                >
                  Ver progresso
                </Link>
              </div>
