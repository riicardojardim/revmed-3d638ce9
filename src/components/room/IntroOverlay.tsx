...
export type IntroVariant = "classic" | "door" | "corridor" | "xray" | "stamp";
export type { IntroRole };

export const INTRO_DURATION_MS = Math.max(CLASSIC_DURATION, DOOR_DURATION, CORRIDOR_DURATION, XRAY_DURATION, STAMP_DURATION);
