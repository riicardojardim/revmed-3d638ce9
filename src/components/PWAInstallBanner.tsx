...
export function PWAInstallBanner() {
  ...
  return (
    <>
      <div
        className="fixed left-1/2 z-50 w-[calc(100vw-1.5rem)] max-w-[360px] rounded-full border border-mint/40 bg-background/95 px-3 py-1.5 shadow-elegant backdrop-blur-xl touch-pan-y select-none sm:max-w-[440px]"
        role="dialog"
