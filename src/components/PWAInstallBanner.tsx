      ...
      >
        <div className="flex h-6 items-center gap-1.5">
          ...
          <button
            ...
            className="inline-flex h-[14px] shrink-0 items-center gap-0.5 rounded-full bg-mint px-1.5 py-0 text-[8px] font-semibold leading-none text-background hover:bg-mint/90"
          >
